namespace Argo_Books.Rentals
{
    partial class Rentals_Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            CurrentRentals_Button = new Guna.UI2.WinForms.Guna2Button();
            ...
            //
            // CurrentRentals_Button
            //
            CurrentRentals_Button.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            CurrentRentals_Button.BorderRadius = 4;
            CurrentRentals_Button.CustomizableEdges = customizableEdges1;
            CurrentRentals_Button.Font = new Font("Segoe UI", 10F);
            CurrentRentals_Button.ForeColor = Color.White;
            CurrentRentals_Button.Location = new Point(703, 33);
            CurrentRentals_Button.Margin = new Padding(4, 5, 4, 5);
            CurrentRentals_Button.Name = "CurrentRentals_Button";
            CurrentRentals_Button.ShadowDecoration.CustomizableEdges = customizableEdges2;
            CurrentRentals_Button.Size = new Size(220, 50);
            CurrentRentals_Button.TabIndex = 1;
            CurrentRentals_Button.Text = "Current Rentals";
            CurrentRentals_Button.Click += CurrentRentals_Button_Click;
            //
            // AddRentalItem_Button
            //
            AddRentalItem_Button.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            AddRentalItem_Button.BorderRadius = 4;
            AddRentalItem_Button.CustomizableEdges = customizableEdges3;
            ...
            AddRentalItem_Button.ShadowDecoration.CustomizableEdges = customizableEdges4;
            AddRentalItem_Button.Size = new Size(220, 50);
            AddRentalItem_Button.TabIndex = 2;
            ...
            ShowingResultsFor_Label.TabIndex = 4;
            ...
            Controls.Add(CurrentRentals_Button);
        ...
        private Guna.UI2.WinForms.Guna2Button CurrentRentals_Button;
