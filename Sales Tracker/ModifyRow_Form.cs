...
namespace Sales_Tracker
{
    public partial class ModifyRow_Form : Form
    {
            ...
            foreach (DataGridViewColumn column in selectedRow.DataGridView.Columns)
            {
                ...
                switch (columnName)
                {
                    ...
                    case nameof(Products_Form.Column.ProductCategory):
                        ...
                        SearchBox.Attach(ProductCategory_TextBox, this, GetSearchResults, searchBoxMaxHeight, false, false, false);
                    ...
                    case nameof(Products_Form.Column.CountryOfOrigin):
                        ...
                        SearchBox.Attach(textBox, this, () => Country.countries, searchBoxMaxHeight, false, true, false);
                    ...
                    case nameof(Products_Form.Column.CompanyOfOrigin):
                        ...
                        SearchBox.Attach(textBox, this, () => searchResult, searchBoxMaxHeight, false, false, false);
                        textBox.TextChanged += ValidateInputs;
                        break;
                }
            ...
            foreach (DataGridViewColumn column in selectedRow.DataGridView.Columns)
            {
                ...
                switch (columnName)
                {
                    ...
                    case nameof(MainMenu_Form.Column.Accountant):
                        ...
                        SearchBox.Attach(Accountant_TextBox, this, () => searchResult, searchBoxMaxHeight, false, false, false);
                    ...
                    case nameof(MainMenu_Form.Column.Product):
                        if (cellValue != ReadOnlyVariables.MultipleItems_text)
                        {
                            ...
                            SearchBox.Attach(ProductName_TextBox, this, GetProductListForSearchBox, searchBoxMaxHeight, true, false, false);
        ...
        private Guna2TextBox ConstructTextBox(int left, string name, string text, int maxLength, CustomControls.KeyPressValidation keyPressValidation, bool pressSaveButton, bool smallWidth, bool closeSearchBox, Control control)
        {
