...
namespace Sales_Tracker
{
    public partial class AddSale_Form : BaseForm
    {
        ...
        private void AddSearchBoxEvents()
        {
            ...
            BuyerName_TextBox.TextChanged += (sender, e) => { SearchBox.SearchTextBoxChanged(this, BuyerName_TextBox, searchResults, this, AddSale_Button, maxHeight); };
            ...
            List<SearchBox.SearchResult> searchResults2 = SearchBox.ConvertToSearchResults(MainMenu_Form.Instance.GetProductSaleNames());

            ProductName_TextBox.Click += (sender, e) => { ShowSearchBox(ProductName_TextBox, searchResults2, maxHeight); };
            ProductName_TextBox.GotFocus += (sender, e) => { ShowSearchBox(ProductName_TextBox, searchResults2, maxHeight); };
            ProductName_TextBox.TextChanged += (sender, e) => { SearchBox.SearchTextBoxChanged(this, ProductName_TextBox, searchResults2, this, AddSale_Button, maxHeight); };
